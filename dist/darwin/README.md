...
循环结构：30-45秒为一个完整闭环（Hook 3-5s → 卖点深度介绍 15-22s → 社交证明 3-5s → CTA+价格 8-13s）

| 维度 | 默认权重 | 说明 |
|------|----------|------|
| 黄金3秒 | 9 | 前3-5秒强Hook：抓兴趣+预告本循环价值 |
| 单点卖点深度介绍 | 7 | 用15-22秒、数据/场景/原理/对比把单个卖点说透 |
| 循环结构 | 7 | 是否由30-45秒独立循环组成 |
| 行动号召CTA | 3 | 循环末尾清晰路径指引即可，不奖励高频重复逼单 |
| 节奏密度 | 5 | 信息密度高但允许必要展开 |
| 痛点速击 | 5 | 前8-12秒是否戳中痛点 |
| 价格锚点 | 5 | 是否在卖点之后从容建立价格对比 |
| 入场信号 | 4 | 新观众能否立即理解上下文 |
